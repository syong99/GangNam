...
# FastApi 애플리케이션 에서 Jinja2 템플릿 엔지을 사용하도록 설정
...
# 비동기 함수를 사용하면 더 많은 클라이언트 요청을 동싱 처리할 수 있다.

@app.get("/") # Request : HTTP 요청객체를 포함. # depends 키워드로 인해 세션 객체가 먼저 생성됨
