...
# 추상화된 데이터와 함수를 하나의 단위로 묶어 클래스를 만들 수 있고,
...
student1.disply_info()
student2.disply_info()
...
class BankAccount:
    ...
    def __init__(self,account_number,balance):
        ...
        self.__balance = balance             # __비공개 속성
...
# 계좌 생성
my_account = BankAccount("123-456-789", 1000000)
...
class Learner:
    ...
    def learn(self):
        return 'i am leraning python'
    
class Student1(Person, Learner): # 다중 상속시 왼쪽에서 오른쪽 순으로 찾는다.
    pass
